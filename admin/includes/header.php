<div class="navbar navbar-inverse set-radius-zero" >
    ...
    <!-- LOGO HEADER END-->
    <section class="menu-section" style="background-color:black;">
        <div class="container">
            <div class="row ">
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right focus">
                            <li><a href="dashboard.php" class="">DASHBOARD</a></li>
                           
                            <li>
                                <a href="#" class="dropdown-toggle" id="ddlmenuItem" data-toggle="dropdown"> Categories <i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu ddlmenuItem1" role="menu" aria-labelledby="ddlmenuItem">
 ...
 <li>
                           ...
                           <li>
                             ...
                             <li><a href="book-request.php">Books requests</a></li>
